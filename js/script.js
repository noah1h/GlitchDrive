...
const carData = {
  'Porsche 911 GT3': {
    ...
    detailsImg: '../imgs/Porsche.jpg',
    engineImg: '../imgs/engine.jpg',
    moreDetailsImg: '../imgs/porsche-interior.jpg',
    price: '99,999',
  ...
  'BMW M4': {
    ...
    detailsImg: '../imgs/BMW.jpg',
    engineImg: '../imgs/engine.jpg',
    moreDetailsImg: '../imgs/BMW-interior.jpg',
    price: '89,999',
  ...
  'Mercedes-AMG GT63': {
    ...
    detailsImg: '../imgs/Mercedes.jpg',
    engineImg: '../imgs/engine.jpg',
    moreDetailsImg: '../imgs/class-s.jpg',
    price: '159,999',
  ...
  'Audi RS5 Sportback': {
    ...
    detailsImg: '../imgs/Audi.jpg',
    engineImg: '../imgs/engine.jpg',
    moreDetailsImg: '../imgs/audi interior.jpg',
    price: '79,999',
  ...
  'Mercedes-Benz G-Class G63 AMG': {
    ...
    detailsImg: '../imgs/G-class.jpg',
    engineImg: '../imgs/engine.jpg',
    moreDetailsImg: '../imgs/gclass-interior.jpg',
    price: '179,999',
...
$(document).ready(function() {
  ...
  if (window.location.pathname.includes('car-details.html') || $('#carDetails').length) {
    ...
    $('.buy-car-price').text('$' + car.price);
      ...
      // Update page title
      $('title').text('GlitchDrive - ' + car.title);
    }
  }
});
